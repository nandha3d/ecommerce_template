...
| `Payment` | Payment gateway integrations (Stripe, PayPal ready) |
| `Pricing` | Dynamic pricing rules, discounts, coupon engine |
| `Product` | Product entity, variations, media management |
| `System` | Site settings, configuration, and feature flags |
...
product_variants         -- Product variations (size, color combinations)
product_attributes       -- Attribute definitions (Size, Color, Flavor)
product_attribute_options -- Attribute values (Small, Medium, Large)
product_attribute_values -- Variant attribute mappings
