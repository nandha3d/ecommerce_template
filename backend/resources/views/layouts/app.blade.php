...
<head>
    ...
    <!-- Dynamic SEO -->
    <title>@yield('title', config('app.name') . ' - Premium Products')</title>
    ...
    <header class="fixed w-full z-50 glass border-b border-gray-100 transition-all duration-300">
        <nav class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <a href="/" class="flex items-center gap-2 group">
                ...
                <span class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-700">{{ config('app.name') }}</span>
            </a>
